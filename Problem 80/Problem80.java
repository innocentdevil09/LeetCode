...
public class Problem80 {
    ...
    /**
     * My first approach included swapping elements by using a method to find ceiling index of the next greater element.
     * Time complexity of that was slightly greater than O(n).
     *
     * However the current approach is elegant and fulfills the criteria of the given query efficiently.
     * Time complexity: O(n)
     *
     * @param nums
     * @return
