...
public class Problem165 {
    ...
    /**
     * Two pass method using split to compare versions
     *
    ...
    private static int compareVersion(String version1, String version2) {
        ...
        int max = Math.max(subVersions1.length, subVersions2.length);
        for (int i = 0; i < max; i++) {
            int v1 = i < subVersions1.length ? Integer.parseInt(subVersions1[i]) : 0;
            int v2 = i < subVersions2.length ? Integer.parseInt(subVersions2[i]) : 0;
